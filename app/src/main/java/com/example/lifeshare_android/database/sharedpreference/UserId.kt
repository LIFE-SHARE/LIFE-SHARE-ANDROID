package com.example.lifeshare_android.database.sharedpreference
...
class UserId(context: Context) : ContextWrapper(context) {
    var id: String = ""
        get() {
            val sharedPreferences: SharedPreferences = getSharedPreferences("lifeshare_android", Context.MODE_PRIVATE)
