...
import com.example.lifeshare_android.network.api.AddHouseApiJava;
...
public class AddHouseActivity extends BaseActivityJava<ActivityAddHouseBinding> {
    ...
    AddHouseApiJava addHouseApiJava = UtilsJava.RETROFIT.create(AddHouseApiJava.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        binding.addRoomBtn.setOnClickListener(v -> {
            ...
            Call<AddHouseRequest> reportRequestCall = addHouseApiJava.postHouse(token.getToken(),
                    houseNameText, housePlaceText, genderText, ageLimitText, contractperiodText, maxMemberText, infoText, part);

            reportRequestCall.enqueue(new Callback<AddHouseRequest>() {
                @Override
